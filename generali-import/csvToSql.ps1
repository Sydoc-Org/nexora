...
(
        ...
        $($row.DOC_KOMMUNIKATION -eq 'null' ? 'NULL' : "'$($row.DOC_KOMMUNIKATION.Replace("'","''"))'"),
        ...
        $($row.DOC_DOKUMENTENTYP -eq 'null' ? 'NULL' : "'$($row.DOC_DOKUMENTENTYP.Replace("'","''"))'"),
        $($row.DOC_EMPFAENGER -eq 'null' ? 'NULL' : "'$($row.DOC_EMPFAENGER.Replace("'","''"))'"),
        $($row.DOC_EMPFAENGERADRESSE -eq 'null' ? 'NULL' : "'$($row.DOC_EMPFAENGERADRESSE.Replace("'","''"))'"),
        $($row.DOC_SPRACHE -eq 'null' ? 'NULL' : "'$($row.DOC_SPRACHE.Replace("'","''"))'"),
        $($row.DOC_NOTIFIKATIONSSTATUS -eq 'null' ? 'NULL' : "'$($row.DOC_NOTIFIKATIONSSTATUS.Replace("'","''"))'"),
        $($row.DOC_VERTRAULICHKEIT -eq 'null' ? 'NULL' : "'$($row.DOC_VERTRAULICHKEIT.Replace("'","''"))'"),
        
        $($row.DOC_RICHTUNG -eq 'null' ? 'NULL' : "'$($row.DOC_RICHTUNG.Replace("'","''"))'"),
        ...
        $($row.DOC_DOKUMENTENSTATUS -eq 'null' ? 'NULL' : "'$($row.DOC_DOKUMENTENSTATUS.Replace("'","''"))'"),
        $($row.DOC_DOKUMENT_URL -eq 'null' ? 'NULL' : "'$($row.DOC_DOKUMENT_URL.Replace("'","''"))'"),
        $($row.DOC_EINGANGSKANAL -eq 'null' ? 'NULL' : "'$($row.DOC_EINGANGSKANAL.Replace("'","''"))'"),
        ...
        $($row.DOC_SCANORT -eq 'null' ? 'NULL' : "'$($row.DOC_SCANORT.Replace("'","''"))'"),
        ...
        $($row.DOC_WAEHRUNG -eq 'null' ? 'NULL' : "'$($row.DOC_WAEHRUNG.Replace("'","''"))'"),
        ...
        $($row.DOC_ORIGIN -eq 'null' ? 'NULL' : "'$($row.DOC_ORIGIN.Replace("'","''"))'"),
        $($row.DOC_INTERFACE_LINK -eq 'null' ? 'NULL' : "'$($row.DOC_INTERFACE_LINK.Replace("'","''"))'"),
        $($row.DOC_NK1 -eq 'null' ? 'NULL' : "'$($row.DOC_NK1.Replace("'","''"))'"),
        $($row.DOC_NK2 -eq 'null' ? 'NULL' : "'$($row.DOC_NK2.Replace("'","''"))'")
)
"@
